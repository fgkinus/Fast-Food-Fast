...
class TestAccounts(object):
    ...
    def test_user_create(self):
        user = Models.User(username='test', firstname='firstname', surname='sir', secondname='second', password='pass',
                           email='test@test.com')
        assert user.username == 'test'
        assert hasattr(user, 'password') is True

    def test_admin_create(self):
        user = Models.Admin(username='test-admin', firstname='firstname', surname='sir', secondname='second',
                            password='pass',
    ...
    def test_set_user_id_method(self):
        ...
        user = Models.User(username='test-admin', firstname='firstname', surname='sir', secondname='second',
                           password='pass',
                           email='test@admin.com')
