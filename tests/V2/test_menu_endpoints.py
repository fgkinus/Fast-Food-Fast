...
class TestMenuItems(object):
    ...
    def test_add_menu_item(self, test_client_2, create_admin_token):
        """add a new menu item"""
        response = test_client_2.post(urls_v2[menu_ns_2] + '/', data=dict(
            name='test_item',
            price=500
        ),
                                      headers=create_admin_token
                                      )
        response2 = test_client_2.post(urls_v2[menu_ns_2] + '/', data=dict(
            name='test_item3',
            price=500
        ),
                                       headers=create_admin_token
    ...
    def test_edit_menu_item(self, test_client_2, create_admin_token):
        ...
        assert response['details'][0]['name'] == 'test-item2'
